...
class ImageCaptcha(_Captcha):
    ...
    def generate_image(self, chars, noise_dots=True, noise_curve=True, smooth=True):
    ...
    def generate_image_pair(self, chars, noise_dots=True, noise_curve=True, smooth=True):
        """Generate the image of the given characters.
        ...
        img_ns = im.copy()
        if noise_dots:
            self.create_noise_dots(img_ns, color)
        if noise_curve:
